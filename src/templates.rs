...
pub enum Args {
	/// Outputs the contents of a template to standard output.
	#[structopt(name = "dump")]
	Dump {
		/// Name of template to dump
	...
	/// Open the template folder in a file browser.
	#[structopt(name = "show")]
	Show {
		/// Output the path to the template folder to standard output instead.
		#[structopt(name = "show_path")]
		path: bool
	},
}
